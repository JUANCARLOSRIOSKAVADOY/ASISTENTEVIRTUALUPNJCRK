var CursoMaterial = function () {
    return{
        init_validacion: function () {
            $('#frm_cursoMaterial').off('submit');
            $('#frm_cursoMaterial').on('submit', function (e) {
                var f = $(this);
                f.parsley().validate
                ...
                if (f.parsley().isValid()) {
                    ...
                    $.ajax({
                        url: root + '/CursoMaterial/GuardarCursoMaterial',
                        data: formData,
                        type: "POST",
                        dataType: 'json',
                        contentType: false,
                        ...
                        success: function (data) {
                            ...
                            CursoMaterial.empty_field();
                            CursoMaterial.disable_field();
        ...
        load_editar: function (cursoid,materialid) {
            $.ajax({
                url: root + '/CursoMaterial/ObtenerCursoMaterialById',
                data: {
                    cursoid: cursoid,
        ...
        load_eliminar: function (cursoid, materialid) {
            $.ajax({
                url: root + '/CursoMaterial/EliminarCursoMaterialById',
                data: {
                    cursoid: cursoid,
                    materialid: materialid
                },
...
$(document).ready(function () {
    CursoMaterial.init_datatable();
    CursoMaterial.init_form();
    CursoMaterial.init_events_btn_submit();
    CursoMaterial.init_validacion();
    /*Curso.init_check();
    Curso.init_filtros();*/
});