var Curso = function () {
    return{
        init_validacion: function () {
            ...
            $('#frm_curso').on('submit', function (e) {
                ...
                if (f.parsley().isValid()) {
                    ...
                    formData.append("id", $("#cursoid").val());
                    formData.append("descripcion", $("#descripcion").val());
                    formData.append("estado", $("#estado").is(":checked"));

                    $.ajax({
                        url: root + '/Curso/GuardarCurso',
                        data: formData,
                        type: "POST",
                        dataType: 'json',
                        contentType: false,
        ...
        load_editar: function (cursoid) {
            $.ajax({
                url: root + '/Curso/ObtenerCursoById',
                data: {
                    cursoid: cursoid
                },
                type: "POST",
...
$(document).ready(function () {
    Curso.init_check();
    Curso.init_filtros();
    Curso.init_datatable();
    Curso.init_events_btn_submit();
    Curso.init_validacion();
});